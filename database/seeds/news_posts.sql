...
VALUES
(
  '10 mẹo tối ưu Windows 11 giúp tăng tốc máy tính và chơi game mượt hơn 2026',
  '10-meo-toi-uu-windows-11-tang-toc-may-tinh-choi-game',
  'Hướng dẫn chi tiết các bước tối ưu hóa hệ điều hành Windows 11 giúp giảm ngốn RAM, tắt ứng dụng chạy ngầm và tăng FPS khi chơi game.',
  ':::summary
...
(
  ...
  'so-sanh-intel-i9-14900k-vs-amd-ryzen-7-7800x3d-vua-gaming',
...
VALUES
(
  'Hướng dẫn chọn mua laptop sinh viên 2026: Đủ mỏng nhẹ, pin trâu và tối ưu ngân sách',
  'huong-dan-chon-laptop-sinh-vien-2026',
  'Kinh nghiệm chi tiết chọn mua laptop cho sinh viên các ngành Công nghệ thông tin, Kinh tế và Đồ họa năm 2026.',
  ':::summary
...
VALUES
(
  'Hướng dẫn chọn mua SSD NVMe PCIe 4.0 tốt nhất năm 2026',
  'huong-dan-chon-mua-ssd-nvme-pcie-4-0-tot-nhat',
  'Phân tích chi tiết tốc độ đọc ghi, chỉ số độ bền TBW và tiêu chí chọn ổ SSD NVMe PCIe 4.0 mượt mà cho PC & Laptop.',
  ':::summary
...
VALUES
(
  'Đánh giá chi tiết Intel Core Ultra 9 285K: Bước tiến hay bước lùi?',
  'danh-gia-chi-tiet-intel-core-ultra-9-285k',
  'Phân tích kiến trúc Arrow Lake, hiệu năng đa nhân, NPU tích hợp và điện năng tiêu thụ của Intel Core Ultra 9 285K.',
  ':::summary
...
VALUES
(
  'NVIDIA RTX 50 Series chính thức lộ diện: Bước nhảy vọt về AI và Ray Tracing',
  'nvidia-rtx-50-series-chinh-thuc-lo-dien',
  'Đánh giá kiến trúc Blackwell, DLSS 4 và hiệu năng xử lý đồ họa thế hệ mới của NVIDIA GeForce RTX 5090 và RTX 5080.',
  ':::summary
