...
CREATE TABLE IF NOT EXISTS products (
    ...
    verification_status ENUM('unverified', 'needs_review', 'verified', 'rejected') NOT NULL DEFAULT 'unverified',
    ...
    UNIQUE INDEX idx_products_canonical_model_key (canonical_model_key),
