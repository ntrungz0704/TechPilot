...
class CatalogGroupService
{
    ...
    private static array $keywordAliasMap = [
        ...
        'linh kiện pc'      => ['mainboard', 'cpu', 'vga', 'ram', 'storage', 'case', 'cooling', 'psu'],
        'linh kien pc'      => ['mainboard', 'cpu', 'vga', 'ram', 'storage', 'case', 'cooling', 'psu'],
        ...
        'gaming gear'       => ['keyboard', 'mouse', 'chair', 'headset', 'speaker'],
        'gear'              => ['keyboard', 'mouse', 'chair', 'headset', 'speaker'],
        'bàn phím'          => ['keyboard'],
        'ban phim'          => ['keyboard'],
        'chuột'             => ['mouse'],
        'chuot'             => ['mouse'],
    ...
    public static function resolveSourceSlugs(string $slugOrAlias): array
    {
        ...
        if (self::isExactSourceSlug($input)) {
            return [$input];
        }
