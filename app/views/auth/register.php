...
<section class="auth-section container">
    <div class="auth-card">
        ...
        <form method="post" action="<?= url('auth/register') ?>" class="auth-form" novalidate>
            ...
            <label class="checkbox agree-terms" style="display: flex; align-items: flex-start; gap: 8px; font-size: 13.5px; line-height: 1.4; margin-bottom: 20px;">
                <input type="checkbox" required style="margin-top: 3px;">
                <span>Tôi đồng ý với <a href="#" style="color: var(--primary); font-weight: 600; text-decoration: none;">Điều khoản dịch vụ</a> và <a href="#" style="color: var(--primary); font-weight: 600; text-decoration: none;">Chính sách bảo mật</a></span>
            </label>
