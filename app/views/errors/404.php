...
<head>
    ...
    <title>404 Not Found - TechPilot</title>
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .error-code { font-size: 72px; font-weight: 800; color: #0b63e5; line-height: 1; margin-bottom: 16px; }
...
<body>
    <div class="error-card">
        ...
        <p class="error-desc">Đường dẫn bạn yêu cầu không tồn tại hoặc đã được di chuyển sang địa chỉ mới. Vui lòng bấm nút bên dưới để quay về trang chủ.</p>
