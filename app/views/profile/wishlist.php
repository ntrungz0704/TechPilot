...
<main class="container section" id="main-content" style="margin-top: 40px; min-height: 60vh;">
    <div style="display: flex; gap: 30px; flex-wrap: wrap;">
        <!-- Left Sidebar Menu -->
        <?php $activeMenu = 'wishlist'; include ROOT_PATH . '/app/views/profile/_sidebar.php'; ?>

        <!-- Right Content Area -->
        <div style="flex: 1; min-width: 300px;">
            <div class="section__head" style="margin-bottom: 20px; display: flex; justify-content: space-between; align-items: center;">
            ...
            <?php else: ?>
                <div class="product-grid product-grid--4" style="display: grid; grid-template-columns: repeat(auto-fill, minmax(220px, 1fr)); gap: 20px;">
