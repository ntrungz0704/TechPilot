                        ...
                        <tr>
                            ...
                            <td>
                                <?php if (!empty($pst['image'])): ?>
                                    <img src="<?= postImageUrl($pst['image']) ? alt="TechPilot Asset">" alt="<?= e($pst['title']) ?>" style="width: 100px; height: 50px; object-fit: cover; border: 1px solid var(--border); border-radius: 4px;">
                                <?php else: ?>
