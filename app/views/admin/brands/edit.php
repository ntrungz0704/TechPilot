        ...
        <div class="form-group" style="border: 1px dashed var(--border); padding: 15px; border-radius: 8px; background-color: #F9FAFB;">
            ...
            <?php if (!empty($brand['logo'])): ?>
                <div style="margin-bottom: 15px;">
                    ...
                    <img src="<?= url('assets/images/brands/' . e($brand['logo'])) ?>" alt="<?= e($brand['name']) ?>" style="height: 40px; object-fit: contain; border: 1px solid var(--border); padding: 4px; border-radius: 4px; background: #FFF;" onerror="this.src='https://placehold.co/100x40?text=<?= urlencode(e($brand['name'])) ?>'">
                </div>
            <?php endif; ?>
