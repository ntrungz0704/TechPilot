                ...
                <?php if (!empty($brands)): ?>
                    <?php foreach ($brands as $b): ?>
                        <tr>
                            ...
                            <td>
                                <?php if (!empty($b['logo'])): ?>
                                    <img src="<?= url('assets/images/brands/' . e($b['logo'])) ?>" alt="<?= e($b['name']) ?>" style="height: 36px; max-width: 100px; object-fit: contain; display: block;" onerror="this.src='https://placehold.co/100x36?text=<?= urlencode(e($b['name'])) ?>'">
                                <?php else: ?>
